...
const buildFieldMapping = (formData: FormData = {}, senerio: string): { [key: string]: any } => {
    ...
    return {
        ...
        "veh equip #.0": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[0]?.equipment || '' : '',

        "veh lic plate #.1": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[1]?.plate || '' : '',
        "veh id #.1": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[1]?.vin || '' : '',
        "veh make.1": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[1]?.make || '' : '',
        "veh equip #.1": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[1]?.equipment || '' : '',

        "veh lic plate #.2": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[2]?.plate || '' : '',
        "veh id #.2": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[2]?.vin || '' : '',
        "veh make.2": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[2]?.make || '' : '',
        "veh equip #.2": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[2]?.equipment || '' : '',

        "veh lic plate #.3": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[3]?.plate || '' : '',
        "veh id #.3": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[3]?.vin || '' : '',
        "veh make.3": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[3]?.make || '' : '',
        "veh equip #.3": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[3]?.equipment || '' : '',

        "veh lic plate #.4": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[4]?.plate || '' : '',
        "veh id #.4": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[4]?.vin || '' : '',
        "veh make.4": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[4]?.make || '' : '',
        "veh equip #.4": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[4]?.equipment || '' : '',

        "veh lic plate #.5": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[5]?.plate || '' : '',
        "veh id #.5": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[5]?.vin || '' : '',
        "veh make.5": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[5]?.make || '' : '',
        "veh equip #.5": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[5]?.equipment || '' : '',

        "veh lic plate #.6": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[6]?.plate || '' : '',
        "veh id #.6": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[6]?.vin || '' : '',
        "veh make.6": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[6]?.make || '' : '',
        "veh equip #.6": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[6]?.equipment || '' : '',

        "veh lic plate #.7": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[7]?.plate || '' : '',
        "veh id #.7": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[7]?.vin || '' : '',
        "veh make.7": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[7]?.make || '' : '',
        "veh equip #.7": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[7]?.equipment || '' : '',

        "veh lic plate #.8": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[8]?.plate || '' : '',
        "veh id #.8": (senerio?.includes("Filing for Planned Non-Operation (PNO)") || senerio?.includes("Certificate of Non-Operation")) ? formData?.plannedNonOperationState?.[8]?.vin || '' : '',
