...
export default function SubscriptionTable({ subscriptions, onCancel }: SubscriptionTableProps) {

    return (
        <div className="p-4 mt-4 w-full">
            <div className="flex justify-between my-2">
                <h2 className="text-xl font-semibold">Subscriptions</h2>
                <button className="px-4 py-2 rounded-sm text-sm bg-black text-white" onClick={() => onCancel(localStorage.getItem("uid") || "")}>Cancel Subscription</button>
            </div>
