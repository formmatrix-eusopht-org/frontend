    ...
    },
    {
        ...
        blocks: [{
            ...
            fields: [
                ...
                {
                    label: "Vehicle Code Type", type: "dropdown", placeholder: "Select Code Type",
                    options: [
                        { label: "Vehicle Under 10,001", value: "Vehicle Under 10,001" },
                        { label: "GVW", value: "GVW" },
                        { label: "CGW", value: "CGW" },
                    ]
                },
                {
                    label: "Weight Range", type: "dropdown", placeholder: "Select Weight Range",
                    options: [
