...
const buildFieldMapping = (formData = {}, senerio) => {
    ...
    return {
        ...
        "PRINT BUYER'S NAME": formData.newOwnerCount > 0 ? newOwner1 : '',
        ...
        "PRINT BUYER'S NAME_1": formData.newOwnerCount > 1 ? newOwner2 : '',
        "SIGNATUREx_1": "",
        "DATE": rawDate,
        "DATE_1": formData.newOwnerCount > 1 ? rawDate : '',
        "DL/ID OR DEALER/DISM #_1": formData.newOwnerData[1]?.['Driver License Number'] || '',
        "PRINT BUYER'S NAME_2": formData.newOwnerCount > 2 ? newOwner3 : '',
        'SIGNATUREx_2': "",
        "DATE_2": formData.newOwnerCount > 2 ? rawDate : '',
        ...
        "4 Date-2": formData.ownersCount > 1 ? formData.ownersData?.[0]?.['Date of Sale'] || '' : '',
        ...
        "true full name of new owner, last, first, middle, suffix, business name, or lessor": formData.newOwnerCount > 0 ? newOwner1 : '',
        ...
        "6 Name First-1": formData.newOwnerCount > 1 ? newOwner2 : '',
        "6 state": formData.newOwnerData[1]?.['State'] || '',
        "6 Name Last-2": formData.newOwnerCount > 2 ? newOwner3 : '',
        ...
        'Text62': formData.newOwnerCount > 0 ? newOwner1 : '',
        'Text73': formData.newOwnerCount > 1 ? newOwner2 : '',
        'Text81': formData.newOwnerCount > 2 ? newOwner3 : '',
        ...
        "from month.0": senerio?.includes("Certificate of Non-Operation") ? formData?.plannedNonOperationState[0]?.fromMonth || '' : ''
    };
};

const mergeFilledPDFs = async (formTypes, formData, senerio) => {
